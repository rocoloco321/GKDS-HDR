...
typedef short    word;
typedef int*  pointer;
typedef struct charkartselect_state_t charkartselect_state_t, *Pcharkartselect_state_t;

struct charkartselect_state_t {
    undefined field_0x0;
    undefined field_0x1;
    undefined field_0x2;
    undefined field_0x3;
    ...
    word items;
    dword charMenuParam;
    pointer kartMenuParam;
    undefined1 kartEmblemStruct; /* Created by retype action */
    ...
    undefined1 requestAvailable; /* Created by retype action */
    ...
    undefined1 kartOffsetDataPointer; /* Created by retype action */
    ...
    GXRgb* pltt; /* Created by retype action */
    struct NNSG3dResTex * resTex;
    ...
    uint16_t field_0x264;
    uint16_t field_0x266;
